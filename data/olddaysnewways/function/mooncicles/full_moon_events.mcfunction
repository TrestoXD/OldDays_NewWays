...
execute if score #moon_type dummy matches 1 run function olddaysnewways:mooncicles/moons/blood_moon_events

execute if score #moon_type dummy matches 2 run tellraw @a {"text":"The \"New Moon\" is rising! Crops grow faster!","color":"gold"}
execute if score #moon_type dummy matches 2 run function olddaysnewways:mooncicles/moons/harvest_moon_events
...
execute if score #moon_type dummy matches 3 run function olddaysnewways:mooncicles/moons/blue_moon_events
