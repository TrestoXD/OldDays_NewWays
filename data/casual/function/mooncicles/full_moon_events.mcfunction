...
execute if score #moon_type dummy matches 1 run tellraw @a {"text":"The \"Blood Moon\" is rising! Undead enemies are stronger!","color":"red"}
execute if score #moon_type dummy matches 1 run function casual:mooncicles/moons/blood_moon_events

execute if score #moon_type dummy matches 2 run tellraw @a {"text":"The \"Harvest Moon\" is rising! Crops grow faster!","color":"gold"}
execute if score #moon_type dummy matches 2 run function casual:mooncicles/moons/harvest_moon_events

execute if score #moon_type dummy matches 3 run tellraw @a {"text":"The \"Blue Moon\" is rising! Fortune favors the miners!","color":"aqua"}
