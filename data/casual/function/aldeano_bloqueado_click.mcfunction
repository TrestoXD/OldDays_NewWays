...
execute as @e[type=minecraft:villager,distance=..3,sort=nearest,limit=1] if data entity @s Brain.memories."minecraft:last_slept" run function casual:quitar_barrera
