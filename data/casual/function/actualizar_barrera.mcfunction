...
execute as @e[type=minecraft:villager,distance=..2,limit=1,sort=nearest] unless data entity @s Brain.memories."minecraft:last_slept" run schedule function casual:actualizar_barrera 2t